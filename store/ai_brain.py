...
def run_ai_optimization():
    ...
    for product in products:
        ...
        # If many people view but don't buy, it's popular but needs a push.
        # If Sales/Views ratio is high, it's a Bestseller.
        ...
        if product.ai_pricing_active:
            # SCENARIO A: High Demand (Increase Price by 5%)
            if total_sold > 10:
                new_price = old_price * 1.05
                action = "📈 Price UP (High Demand)"
            
            # SCENARIO B: No Sales, High Views (Decrease Price by 5% to tempt buyers)
            ...
            # Update Price (Round to nearest 9, e.g., 499, 599)
