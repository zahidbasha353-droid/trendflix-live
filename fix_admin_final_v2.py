...
print("-" * 50)
print("🔧 FIXING ADMIN PANEL (FORMAT_HTML ERROR)...")
print("-" * 50)

# CORRECT ADMIN CODE (Fixed format_html syntax)
...
class ProductAdmin(admin.ModelAdmin):
    # Removed 'category' from list_filter to prevent errors
...
print("✅ admin.py FIXED (Corrected HTML formatting).")
print("-" * 50)
